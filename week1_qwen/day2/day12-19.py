...
item_db = [
    {"user_id": 1, "item_id": 1, "item_name": "Foo"},
    {"user_id": 2, "item_id": 2, "item_name": "Bar"},
    {"user_id": 3, "item_id": 3, "item_name": "Baz"},
    {"user_id": 4, "item_id": 4, "item_name": "Wux"},
]
...
# 查询参数示例     skip: int = 0, limit: int = 10    支持分页+返回数据✅
@app.get("/items/")
